...
def write():
    ...
    st.markdown(':information_source: All the data are coming from the _World Bank OpenData_ website, you can find the original dataset and the metadata on the github.')
